...
OUTPUT_DIR = r"./experiment_worldview/test_ablation_wdtfnet"
...
ABLATION_CONFIGS: List[Dict[str, Any]] = [
    dict(
        ...
        ckpt=r"./experiment_worldview/ablation_worldview/00_baseline/stage1/stage1_best.pth",
    ),
    dict(
        id=1, name="ablation_1_wgdc", display="1 +WGDC", enabled=True,
        use_wgdc=True, use_fg=False, use_wa=False,
        ckpt=r"./experiment_worldview/ablation_wdtfnet/01_baseline_wgdc/stage1/stage1_best.pth",
    ),
    dict(
        id=2, name="ablation_2_fg", display="2 +FG", enabled=True,
        use_wgdc=False, use_fg=True, use_wa=False,
        ckpt=r"./experiment_worldview/ablation_wdtfnet/02_baseline_fg/stage1/stage1_best.pth",
    ),
    dict(
        id=3, name="ablation_3_wa", display="3 +WA", enabled=True,
        use_wgdc=False, use_fg=False, use_wa=True,
        ckpt=r"./experiment_worldview/ablation_wdtfnet/03_baseline_wa/stage2/stage2_last.pth",
    ),
    dict(
        id=4, name="ablation_4_wo_wgdc", display="4 w/o WGDC", enabled=True,
        use_wgdc=False, use_fg=True, use_wa=True,
        ckpt=r"./experiment_worldview/ablation_wdtfnet/04_wo_wgdc/stage2/stage2_best.pth",
    ),
    dict(
        id=5, name="ablation_5_wo_fg", display="5 w/o FG", enabled=True,
        use_wgdc=True, use_fg=False, use_wa=True,
        ckpt=r"./experiment_worldview/ablation_worldview/05_wo_fg/stage2/stage2_best.pth",
    ),
    dict(
        id=6, name="ablation_6_wo_wa", display="6 w/o WA", enabled=True,
        use_wgdc=True, use_fg=True, use_wa=False,
        ckpt=r"./experiment_worldview/ablation_wdtfnet/07_full_wdtfnet/stage1_best.pth",
    ),
    dict(
